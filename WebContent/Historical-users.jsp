...
<head>
    ...
    function getHistory(){
   		$.post("HistoryServlet",{username:username,password:password},function(date){
...
<body data-type="Historical-users.html">
 ...
 -->
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            <li>
                                <a href="HistoryServlet?currentPage=1&flag=1" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>历史用户信息</span>
                                </a>
        ...
        <div class="tpl-content-wrapper">
            <div class="tpl-content-page-title">
            	<form action="HistoryServlet?currentPage=1&flag=3" method="post">
            		<input type="text" name="select" value="" placeholder="请输入用户名或身份证号"><input type="submit" value="查询">
            	</form>
            	<!-- <form action="HistoryServlet?currentPage=1&flag=2" method="post">
                ...
                <table id="his">
                	<tr>
                		<td>编号&nbsp;&nbsp;&nbsp;&nbsp;</td><td>客户姓名&nbsp;&nbsp;&nbsp;&nbsp;</td><td>客户联系方式&nbsp;&nbsp;&nbsp;&nbsp;</td><td>顾客身份证&nbsp;&nbsp;&nbsp;&nbsp;</td><td>顾客性别&nbsp;&nbsp;&nbsp;&nbsp;</td>
                	</tr>
                	<c:forEach items="${pageHelper.rows}" var="ph" varStatus="idx"> 
                		<tr>
							...
							<td><c:if test="${ph.sex==1}"> 男</c:if>
								<c:if test="${ph.sex==0}"> 女</c:if>
							</td>
						</tr>
	...
	<div id="pagehelper" align="center">
		...
		<c:if test="${requestScope.pageHelper.currentPage>1}">
			<a href="HistoryServlet?currentPage=1&flag=1">首页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="HistoryServlet?currentPage=${requestScope.pageHelper.currentPage-1}&flag=1">上一页</a>
		</c:if>
		&nbsp;&nbsp;&nbsp;&nbsp; 第${requestScope.pageHelper.currentPage}页
		&nbsp;&nbsp;&nbsp;&nbsp;
		<c:if
			test="${requestScope.pageHelper.currentPage<requestScope.pageHelper.totalPage}">
			<a href="HistoryServlet?currentPage=${requestScope.pageHelper.currentPage+1}&flag=1">下一页</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="HistoryServlet?currentPage=${requestScope.pageHelper.totalPage}&flag=1">尾页</a>
		</c:if>
		&nbsp;&nbsp;&nbsp;&nbsp;
