...
public class RoomDaoImplGH extends BaseDao implements RoomDaoGH {
    ...
    public Room getRoomById(int roomId) {
        ...
        try {
        	...
        	DBConnectionUtil.CloseConnection(rs, pstmt, conn);//关闭资源
        }
        return room;
    }
    ...
    public List<Room> getRooms(int pageNo, int pageSize,int attruCode, String value) {
        ...
        try {
            conn=DBConnectionUtil.getConnection();
            pstmt=conn.prepareStatement(SQL.getRoomQuerySqlByPage(pageNo,pageSize,attruCode,value));
    ...
    public int getRoomsCount(int attrCode, String value) {
        ...
        try {
            conn=DBConnectionUtil.getConnection();
            String sql=SQL.getRoomQueryByCount(attrCode,value);
            pstmt=conn.prepareStatement(sql);
